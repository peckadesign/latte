...
final class Token
{
	...
	public const NAMES = [
		...
		self::Php_LNumber => 'integer',
		self::Php_DNumber => 'floating-point number',
		self::Php_Identifier => 'identifier',
		self::Php_StringVarname => 'variable name',
		self::Php_ConstantString => 'constant',
		...
		self::Php_NameRelative => 'namespace-relative name',
