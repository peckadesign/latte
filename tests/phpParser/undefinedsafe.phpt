...
Latte\Compiler\Nodes\Php\Expr\ArrayNode
   ...
   |  |  value: Latte\Compiler\Nodes\Php\Expr\UndefinedsafePropertyFetchNode
   ...
   |  |  value: Latte\Compiler\Nodes\Php\Expr\UndefinedsafeMethodCallNode
   |  |  |  name: Latte\Compiler\Nodes\Php\IdentifierNode
   |  |  |  |  name: 'b'
   |  |  |  |  line: 2
   |  |  |  var: Latte\Compiler\Nodes\Php\Expr\VariableNode
   ...
   |  |  |  class: Latte\Compiler\Nodes\Php\Expr\UndefinedsafePropertyFetchNode
   |  |  |  |  name: Latte\Compiler\Nodes\Php\IdentifierNode
   |  |  |  |  |  name: 'b'
   |  |  |  |  |  line: 3
   |  |  |  |  var: Latte\Compiler\Nodes\Php\Expr\VariableNode
   ...
   |  |  |  parts: array (1)
   |  |  |  |  0 => Latte\Compiler\Nodes\Php\Expr\UndefinedsafePropertyFetchNode
   |  |  |  |  |  name: Latte\Compiler\Nodes\Php\IdentifierNode
   |  |  |  |  |  |  name: 'b'
   |  |  |  |  |  |  line: 4
   |  |  |  |  |  var: Latte\Compiler\Nodes\Php\Expr\VariableNode
